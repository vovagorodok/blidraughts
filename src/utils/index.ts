import { Network, ConnectionStatusChangeListener } from '@capacitor/network'
...
let networkStatus: ConnectionStatusChangeListener
...
export function lidraughtsAssetSrc(path: string): string {
