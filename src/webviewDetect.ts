...
export default function detectWebview() {
  ...
  function upgradeMsg() {
    ...
    return [
      h('p', `Lidraughts needs a recent version of the rendering engine which is provided by the ${appName} application. In order to get it updated you must not disable it.` ),
