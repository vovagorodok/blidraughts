  ...
  general: {
    ...
    theme: {
      ...
      availableBoardThemes: [
        { name: 'Brown', key: 'brown', ext: 'svg' },
        { name: 'Brown 2', key: 'brown2', ext: 'svg' },
        { name: 'Blue', key: 'blue', ext: 'svg' },
        { name: 'Green', key: 'green', ext: 'svg' },
        { name: 'Grey', key: 'grey', ext: 'jpg' },
        { name: 'Purple', key: 'purple', ext: 'svg' },
        { name: 'Wood', key: 'wood', ext: 'jpg' },
        { name: 'Wood 2', key: 'wood2', ext: 'jpg' },
        { name: 'Wood 3', key: 'wood3', ext: 'jpg' },
        { name: 'Maple', key: 'maple', ext: 'jpg' },
        { name: 'Blue 2', key: 'blue3', ext: 'jpg' },
        { name: 'Canvas', key: 'canvas', ext: 'jpg' },
        { name: 'Metal', key: 'metal', ext: 'jpg' },
        { name: 'Match', key: 'match', ext: 'svg' }
      ],
      bundledBoardThemes: ['brown', 'blue', 'green', 'purple'],
