export default {
  ...
  "someoneYouReportedWasBanned": "Action has been taken against someone you reported",
  ...
  "youCanPasteThisInTheForumToEmbed": "You can paste this in the forum or a Lichess blog to embed",
  ...
  "twoFactorApp": "Get an app for two-factor authentication, for example Google Authenticator for %1$s or %2$s.",
  ...
  "lookupOfPlayer": "Search puzzles from a player's games",
  "fromXGames": "Puzzles from %s's games",
  ...
  "nbPlayed:one": "%s played",
  "nbPlayed:other": "%s played",
  "nbToReplay:one": "%s to replay",
  ...
  "moreBlogPostsBy": "View more blog posts by %s",
