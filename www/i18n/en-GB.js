export default {
  ...
  "topGames": "Top games",
  "masterDbExplanation": "OTB games of %1$s+ FIDE-rated players from %2$s to %3$s",
  ...
  "signupUsernameHint": "Make sure to choose a family-friendly username. You cannot change it later and any accounts with inappropriate usernames will get closed!",
  ...
  "savingMoves": "Temporary move storage",
  "savingMovesHelp": "We're always storing your variations in your browser cache.",
  ...
  "agreementMultipleAccounts": "I agree that I will not create multiple accounts (except for the reasons stated in the %s).",
  ...
  "importFromChapterX": "Import from %s",
  ...
  "youCompletedThisLesson": "Congratulations! You completed this lesson.",
  ...
  "explainShowPlayerRatings": "This allows hiding all ratings from the website, to help focus on the chess. Games can still be rated, this is only about what you get to see.",
  ...
  "explainPromoteToQueenAutomatically": "Hold the <ctrl> key while promoting to temporarily disable auto-promotion",
  ...
  "correspondenceEmailNotification": "Daily mail notification listing your correspondence games",
  "settings": "Settings",
  ...
  "gamesFound:one": "%s game found",
  "gamesFound:other": "%s games found",
  "team": "Team",
  "teams": "Teams",
  "allTeams": "All teams",
  ...
  "joinTeam": "Join team",
  "onlyLeaderLeavesTeam": "Please add a new team leader before leaving, or close the team.",
  "quitTeam": "Leave team",
  ...
  "joinLichessVariantTeam": "Join the official %s team for news and events",
  ...
  "upVote": "Up vote puzzle",
  "downVote": "Down vote puzzle",
  "yourPuzzleRatingWillNotChange": "Your puzzle rating will not change. Note that puzzles are not a competition. Your rating helps selecting the best puzzles for your current skill.",
  ...
  "aCoordinateAppears": "A coordinate appears on the board and you must click on the corresponding square.",
  "aSquareIsHighlightedExplanation": "A square is highlighted on the board and you must enter its coordinate (e.g. \"e4\").",
  "youHaveThirtySeconds": "You have 30 seconds to correctly map as many squares as possible!",
  "goAsLongAsYouWant": "Go as long as you want, there is no time limit!",
  "showCoordinates": "Show coordinates",
  "showPieces": "Show pieces",
  "startTraining": "Start training",
  "findSquare": "Find square",
  ...
  "xBlog": "%s's Blog",
  "newPost": "New post",
  "editYourBlogPost": "Edit your blog post",
  ...
  "drafts": "Drafts",
  "published": "Published",
  "createBlogDiscussion": "Enable comments",
  "createBlogDiscussionHelp": "A forum topic will be created for people to comment on your post",
  "publishOnYourBlog": "Publish on your blog",
  "publishHelp": "If checked, the post will be listed on your blog. If not, it will be private, in your draft posts",
  "xPublishedY": "%1$s published %2$s",
  "thisPostIsPublished": "This post is published",
  "thisIsADraft": "This is a draft",
  "moreBlogPostsBy": "More blog posts by %s",
  "noPostsInThisBlogYet": "No posts in this blog, yet.",
  "noDrafts": "No drafts to show.",
  "latestBlogPosts": "Latest blog posts",
  "uploadAnImageForYourPost": "Upload an image for your post",
  "imageAlt": "Image alternative text",
  "imageCredit": "Image credit",
  "deleteBlog": "Delete this blog post definitively",
  "deleteImage": "Delete the image",
  "safeToUseImages": "It is safe to use images from the following websites: ",
  "selectPostTopics": "Select the topics your post is about",
  "useImagesYouMadeYourself": "You can also use images that you made yourself, pictures you took, screenshots of Lichess... anything that is not copyrighted by someone else.",
  "safeAndRespectfulContent": "Please only post safe and respectful content. Do not copy someone else's content.",
  "inappropriateContentAccountClosed": "Anything inappropriate could get your account closed.",
  "blogTips": "Our simple tips to write great blog posts",
  "publishedNbBlogPosts:one": "Published a blog post",
  "publishedNbBlogPosts:other": "Published %s blog posts",
  "nbViews:one": "One view",
  "nbViews:other": "%s views",
  "viewAllNbPosts:one": "View one post",
  "viewAllNbPosts:other": "View all %s posts",
  ...
  "undoUnsupported": "Undo unsupported",
