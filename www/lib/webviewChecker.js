  ...
  .then(function(pi) {
    ...
    if (majorVersion < 58) {
      navigator.notification.confirm(
        'Lidraughts needs a recent version of the rendering engine which is provided by the "' + pi.packageName + '" application. The version you\'re using is too old (' + pi.versionName + '). Please update it or lidraughts might not work.',
        function(button) {
          if (button === 1) {
